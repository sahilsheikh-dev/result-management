...
import { ClipboardList, BarChart3, Users, FileText, Award, TrendingUp } from 'lucide-react';
...
const TeacherDashboard: React.FC = () => {
  ...
  const teacherClasses = classes.filter(cls => 
    user?.name && cls.classId.includes('10') // Simple filter for demo
  );
    ...
    <div className="space-y-8">
          ...
          <div className="space-y-4">
            {upcomingExams.length > 0 ? (
              upcomingExams.map((exam) => {
                ...
                return (
                  <div key={exam.examId} className="flex items-center justify-between p-4 bg-blue-50 rounded-lg border border-blue-100">
                    <div>
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium text-blue-700">{exam.examType}</p>
          ...
          <div className="space-y-4">
            {recentResults.length > 0 ? (
              recentResults.map((result) => {
                ...
                return (
                  <div key={result.resultId} className="flex items-center justify-between p-4 bg-emerald-50 rounded-lg border border-emerald-100">
                    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white">
          ...
          <p className="text-blue-100 mb-4">Enter marks and evaluate student performance</p>
        ...
        <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl p-6 text-white">
          ...
          <p className="text-emerald-100 mb-4">Review and analyze student performance data</p>
        ...
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-6 text-white">
          ...
          <p className="text-purple-100 mb-4">Track class performance and trends</p>
